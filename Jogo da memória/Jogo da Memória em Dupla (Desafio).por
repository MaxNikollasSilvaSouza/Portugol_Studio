programa
{
	...
	funcao inicio()
	{
		...
		inteiro meteoro,calango, j,pontost = 0, pontos_1 = 0, pontos_2 = 0,palpite_1i, palpite_2i
		...
		faca 
		{
			...
			escreva("Escolha a sua primeira carta jogador 1:\n")
			leia(palpite_1)
			...
			faca
			{
				...
				faca
				{
					faca
					{
						...
						mensagem[6],"\t",mensagem[7],"\t",mensagem[8],"\t",mensagem[9],"\n",mensagem[10],"\t",
						mensagem[11],"\t",mensagem[12],"\t",mensagem[13],"\t",mensagem[14],"\n", "\n")
			escreva("Escolha a sua primeira carta jogador 2:\n")
			leia(palpite_1)
			se (t.cadeia_e_inteiro(palpite_1, 10))
			{
				palpite_1i = t.cadeia_para_inteiro(palpite_1,10)
	...
	limpa()
		...
		escreva ("Jogador 1 fez:" + pontos_1 + "Pontos"+ "\n\n" + "Jogador 2 fez:" + pontos_2+ "Pontos")
